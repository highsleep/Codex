...
const INITIAL_LIFECYCLE: ProductLifecycle[] = [
  ...
  },
  {
    ...
    notes: 'تفعيل وثيقة الضمان الذهبي رقم SLP-WRN-2601-8192 لمدة 10 سنوات تنتهي 2036-01-15',
    reference_id: 'SLP-WRN-2601-8192',
...
const INITIAL_COMMUNICATIONS: CustomerCommunication[] = [
  ...
  // SLP-2026-9081 (أحمد مصطفى الشناوي / 01012345678 / SLP-WRN-2601-8192)
  {
    id: 'COMM-2026-010',
    serial_number: 'SLP-2026-9081',
    warranty_id: 'SLP-WRN-2601-8192',
    ...
    related_reference: 'SLP-WRN-2601-8192',
